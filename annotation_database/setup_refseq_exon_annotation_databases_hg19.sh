...
if [[ $# -ne 2 ]]; then
	...
	echo "/stornext/snfs5/next-gen/scratch/phuang/git_repo/annotation_database/setup_refseq_exon_annotation_databases_hg19.sh target_bed_file output_dir"
	exit
fi
...
/hgsc_software/perl/perl-5.18.2/bin/perl /stornext/snfs5/next-gen/scratch/phuang/git_repo/annotation_database/geneExonAnnotation_hg19.pl "$exon_target_intersect_file"
