...
if [[ $# -ne 2 ]]; then
	...
	echo "/stornext/snfs5/next-gen/scratch/phuang/git_repo/annotation_database/setup_intron_annotation_databases_hg19.sh Sorted_Merged_Partitioned_Exon_FILE output_directory"
	exit
fi
...
# this part should be done already by the setup_exon_annotation_databases.sh script
...
# Finally, dump everything into MySQL database named: Intron_Regions37
#
echo "dump all partitioned introns into MySQL database Intron_Regions37 ==> forIntronicRegions.pl $introns_partitioned"
/hgsc_software/perl/perl-5.18.2/bin/perl /stornext/snfs5/next-gen/scratch/phuang/git_repo/annotation_database/forIntronicRegions_hg19.pl "$final_intron_regions"
