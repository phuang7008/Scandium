...
class HTS_Data {
	public:
		HTS_Data() : initial_vector_size(30) { 
			...
			gene_transcript_exon_map = new unordered_map<string, unordered_map<string, vector<Exon> > >;
			target_annotation_map = new unordered_map<string, unordered_map<string, unordered_map<string, vector<Exon> > > >;
			low_cov_exon_map = new unordered_map<string, unordered_map<string, unordered_map<string, vector<Exon> > > >;
		...
		unordered_map<string, unordered_map<string, unordered_map<string, vector<Exon> > > > * get_low_cov_exon_map() const { return low_cov_exon_map; }
		unordered_map<string, unordered_map<string, unordered_map<string, vector<Exon> > > > * get_target_annotation_map() const { return target_annotation_map; }
		unordered_map<string, unordered_map<string, vector<Exon> > > * get_gene_transcript_exon_map() const { return gene_transcript_exon_map; }
	...
	private:
		...
		//                                      -----> ...
		//
		unordered_map<string, unordered_map<string, unordered_map<string, vector<Exon> > > > * low_cov_exon_map;
