...
do
	...
	echo "/hgsc_software/R/R-3.2.3/bin/Rscript /stornext/snfs5/next-gen/scratch/phuang/git_repo/graph_scripts/R_scripts/OMIM_gene_coverage_graph.R $merged_outfile $infile '1' $LOW $HIGH $max_length 1" | msub -q normal -l nodes=1:ppn=1,mem=5gb -V -d $BASEDIR -N graph -o out_cap$id -e err_cap$id -A proj-dm0001
